...
0. Prepare materials
   ...
   - device with Chrome open to [the virus.sucks app](https://virus.sucks/pluslife_app/), set to stay awake/keep screen on
...
3. Prepare sample
   ...
   - Dispose of the swab.
   - Screw on the cap.
   - Invert and gently flick the tube several times to mix reagents.  
     Don't overdo it, bubbles bad.
   - If visible foam or air bubbles have formed, let the tube briefly
...
3. Transfer sample to the reaction card
   ...
   - Allow the card to stand still for 15 seconds  
     to let gravity deal with bubbles.
   - Firmly press the air button on top of the card cap. Ensure all
     chambers are **completely** filled with liquid.
5. Mixing
   - Quickly shake the card up and down 10 times within 5 seconds,
     ensure the pellets are completely dissolved.
   - Check that no chamber is more than ⅓ bubbles.
6. Amplification
   - Keep phone and other strong electromagnetic fields away from the analyzer while the test is running.
   - Check the device is warmed up and ready.  
   ...
   - Read the result after 35 min.
   - Clean up immediately to avoid contamination.
7. Cleanup
   - Open up the waste bag.
   - Put on the single-use glove.
   - Carefully take the card out of the analyzer, immediately put it
     into the waste bag and seal it.
   - Dispose of the waste bag and the single-use glove ASAP.
   - Turn off the analyzer by holding the button for 3 seconds.
